contract Dodo {
    ...
    function ownerOf(uint256 tokenId) public view virtual override returns (address) {
        ...
        require(owner != address(0), "ERC721: owner query for nonexistent token") check_ownerOf_zero_address;
        return owner;
    }
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(_msgSender() == owner || isApprovedForAll(owner, _msgSender()),"ERC721: approve caller is not owner nor approved for all") check_approve_msg_sender;
