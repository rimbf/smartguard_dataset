...
contract ERC721A is IERC721A {
    ...
    function approve(address to, uint256 tokenId) public payable virtual override {
        ...
        if (_msgSenderERC721A() != owner) check_approve_msg_sender
    ...
    function transferFrom(
        ...
        if (address(uint160(prevOwnershipPacked)) != from) revert TransferFromIncorrectOwner() check_transferFrom_msg_sender ;
